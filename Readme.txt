...
Update-Database -Context Track_Sport_Events_IDContext
...
Update-Database -Context Track_Sport_EventsDataContext



6. After migration is successful Run the project 

7 if you click on Runners/Timing Records  and etc (Except Home) this will redirect you to ASP .net identity login page login from the following credentials

User : admin@tracks.com
Password: 1qaz2wsX@
